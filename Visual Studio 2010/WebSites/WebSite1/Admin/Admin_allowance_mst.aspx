    ...
    <table style="width:100%;">
        <tr>
            <td class="style4" colspan="2" style="text-align: center">
                ...
                <img src="p4.jpeg"style="height: 136px; width: 326px; float: right; margin-left: 0px;" alt="" /></td>
        </tr>
        <tr>
            <td class="style4" colspan="2" style="text-align: center">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ControlToValidate="txtall_name" Display="Dynamic" ErrorMessage="*Enter Allowance name" 
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                    ControlToValidate="txtall_rate" Display="Dynamic" ErrorMessage="*Rate must Required" 
                    SetFocusOnError="True" ForeColor="Red"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
