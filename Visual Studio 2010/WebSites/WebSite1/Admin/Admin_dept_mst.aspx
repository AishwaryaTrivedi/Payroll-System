    ...
    <table style="width:100%;">
        <tr>
            <td class="style4" colspan="2" style="text-align: center">
                 <img src="../e.jpg" style="height: 136px; width: 360px; float: left;" alt="" /><img 
                    src="p4.jpeg" alt=""
                    style="height: 136px; width: 326px; float: right; margin-left: 0px;" /></td>
        </tr>
        <tr>
            <td class="style4" colspan="2" style="text-align: center">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ControlToValidate="txtdept_name" Display="Dynamic" ErrorMessage="Please Enter Department name" 
