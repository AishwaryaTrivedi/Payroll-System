<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Admin_tax_mst.aspx.cs" Inherits="Admin_tax_mst"  %>
    ...
    <table style="width:100%;">
        ...
        <tr>
            <td class="style3" colspan="2">
                <b>Add New Tax :<asp:TextBox ID="txtdept_no" runat="server" 
        ...
        <tr>
            <td class="style1">
                ...
                Name :</td>
            <td>
                <asp:TextBox ID="txttax_name" runat="server" MaxLength="30"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ControlToValidate="txttax_name" Display="Dynamic" ErrorMessage="Required" 
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                    ControlToValidate="txttax_rate" Display="Dynamic" ErrorMessage="Required" 
                    SetFocusOnError="True"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" style="text-align: center">
                <asp:GridView ID="gdvDept" runat="server" AllowPaging="True" 
                    ...
                    <Columns>
                        <asp:BoundField DataField="tax_id" HeaderText="ID" SortExpression="tax_id" />
